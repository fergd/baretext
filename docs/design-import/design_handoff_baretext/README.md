...
All theme colors are semantic and keyed off the same names, so components are theme-agnostic. Set the active theme with `data-theme="dark|light|ayu|dracula"` on a root container (Electron: on the app root, driven by user setting).

### Colors — by theme
| token | dark (native) | light | ayu (green terminal) | dracula |
|---|---|---|---|---|
| `--bg` | `#242424` | `#f5f0e8` | `#0d130d` | `#282a36` |
| `--bg-alt` | `#191919` | `#ede8de` | `#0a0f0a` | `#21222c` |
| `--text` | `#faf2d6` | `#2a2218` | `#c8e6b0` | `#f8f8f2` |
| `--text-dim` | `#bdae93` | `#6b5f4a` | `#5f7a55` | `#6272a4` |
| `--text-dimmer` | `#5a5040` | `#b0a898` | `#2d3d29` | `#44475a` |
| `--accent` | `#f8c537` | `#b8820a` | `#7dc45a` | `#bd93f9` |
| `--border` | `#3a3a3a` | `#d0c8b8` | `#1c281a` | `#44475a` |
| `--cursor` | `--accent` | `--accent` | `--accent` | `--text` ⚠ |
| `--sel` | `rgba(248,197,55,.22)` | `rgba(184,130,10,.20)` | `rgba(125,196,90,.18)` | `rgba(68,71,90,.70)` |
| `--syntax-2` (dates/subheads) | `#f8c537` | `#b8820a` | `#7dc45a` | `#8be9fd` |

⚠ **Dracula is the only theme where the text cursor is `--text`, not `--accent`.**
